...
validate_input(Oracion,X):- is_ayuda(Oracion,Val),(Val ==1 -> printAyuda(),nl,readln(Input),validate_input(Input,X)).
validate_input(Oracion,X):- is_question(Oracion,Val),(Val ==1 ->validate_question(Oracion),nl,readln(Input),validate_input(Input,X)).
